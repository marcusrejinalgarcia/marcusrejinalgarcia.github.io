      ...
      <article className='container mr-auto flex flex-col xl:flex-row lg:px-8 gap-8'>
        <div className='grow max-w-fit'>
          <img 
            ...
            className="m-auto md:mr-4 aspect-square object-cover max-w-sm max-h-60 rounded-2xl border-solid border-8 border-white md:float-left"
          />
        ...
        <div className='flex flex-col place-content-center lg:max-w-md m-auto gap-4'>
          <p className='text-center text-3xl italic font-medium'><span className='text-3xl text-yellow-300'>{'\u275D'}</span> Design is fifty percent <span className='text-3xl text-yellow-300 font-extrabold'> mathematics</span>, whatever percent <span className='text-3xl text-yellow-300 font-extrabold'>instinct</span>. <span className='text-3xl text-yellow-300'>{'\u275E'}</span></p>
